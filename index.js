...
switch (menu) {
  ...
  case "сік":
    ...
    break;
  default:
    alert("Ви обрали напої, яких у нас немає або неправильно написали слово");
    break;
}
...
switch (dayOfWeek) {
  case "понеділок":
    day = "понеділок";
    meanOfDay = "робочий";
    alert(`Ви обрали ${day}, це ${meanOfDay} день`);
    break;
  case "вівторок":
    day = "вівторок";
    meanOfDay = "робочий";
  ...
  case "неділя":
    ...
    break;
  default:
    alert("Ви не ввели день тижня або неправильно написали слово");
    break;
}
...
switch (numberOfMounth) {
  case "01":
    ...
    season = "зима";
    alert(
      `Ви обрали ${nameOfMounth} за номером місяця ${numberOfMounth}, це ${season}`
    );
    break;
  case "02":
    nameOfMounth = "лютий";
  ...
  case "12":
    ...
    break;
  default:
    alert("Ви не ввели номер місяця");
    break;
}
// Завдання 4
...
switch (numberOfMounth) {
  case "01":
    ...
    alert(
      `Ви обрали ${nameOfMounth} за номером місяця ${numberOfMounth}, у ньому ${numberOfDaysInMounth} днів`
    );
    break;
  case "02":
